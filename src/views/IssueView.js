    ...
    _renderIssueCards = () => {
        if (this.state.issues.length === 0) {
            ...
            return this.state.issues.map((issue) =>
                <IssueCard issueId={issue.i_id} title={issue.i_title} description={issue.i_desc} handleDeleteIssue={this.handleDeleteIssue} />
            )
        }
        ...
        return (
            <div className="m-5">
                ...
                <div className="d-flex justify-content-between align-items-center mt-5 mb-5">
                    ...
                    <AddIssueButton data-toggle="modal" data-target="#addIssueModal" />
                </div>
                <div class="modal fade" id="issueUpdateModal" tabIndex="-1" role="dialog" aria-labelledby="IssueUpdateModal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="issueUpdateModalLabel">Edit Project Details</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value={selectedIssue.i_title} onChange={this.handleTitleChange} className="form-control" placeholder="Enter Title of the Project" ></input>
                                </div>
                                <div class="form-group">
                                    <label className="ml-2">Description</label>
                                    <textarea className="form-control" value={selectedIssue.i_desc} onChange={this.handleDescriptionChange} placeholder="Enter Description of the Project" ></textarea>
                                </div>
                            </div>
