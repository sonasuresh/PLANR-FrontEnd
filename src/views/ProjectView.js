        ...
        return <div className="row">
            {
                this.state.projects.map((project) =>
                    <div className="col-sm-12 col-md-12 col-lg-4 col-xl-3">
                        <ProjectCard title={project.p_name} description={project.p_desc} projectId={project.p_id} handleDeleteProject={this.handleDeleteProject} handleUpdateProjectClick={this.handleUpdateProjectClick} />
                    </div>
                )
            }
        </div>
        ...
        return (
            <div className="m-5">
                ...
                <div className="d-flex justify-content-between align-items-center mt-5 mb-5">
                    ...
                    <AddProjectButton data-toggle="modal" data-target="#addProjectModal" />
                </div>
                <AddProjectModal />
                <div class="modal fade" id="projectUpdateModal" tabIndex="-1" role="dialog" aria-labelledby="projectUpdateModal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="projectUpdateModalLabel">Edit Project Details</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value={selectedProject.p_name} onChange={this.handleTitleChange} className="form-control" placeholder="Enter Title of the Project" ></input>
                                </div>
                                <div class="form-group">
                                    <label className="ml-2">Description</label>
                                    <textarea className="form-control" value={selectedProject.p_desc} onChange={this.handleDescriptionChange} placeholder="Enter Description of the Project" ></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick={this.handleCancel}>Cancel</button>
